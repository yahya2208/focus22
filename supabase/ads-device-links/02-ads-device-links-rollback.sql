...
--
-- Reverses 01-ads-device-links-apply.sql COMPLETELY: drops the 5 added
...
-- removes the 5 column-dependent constraints, so dropping constraints first is
-- for explicitness; either order is safe.
--
-- ROLLBACK (owner executes only if a full reversal is required):
-- ============================================================================

ALTER TABLE public.ads DROP CONSTRAINT IF EXISTS ads_device_requires_phone_link;
...
-- ============================================================================
-- Verify rollback: the column and all 5 constraints must now be ABSENT:
