-- ============================================================================
-- FOCUS — CENTRAL INVENTORY (PHASE 2C REVISED DRAFT — APPLY)
--
-- Type: Additive (CREATE TABLE / FUNCTION / POLICY / VIEW / BUCKET only)
-- Status: PHASE 2C REVISED DRAFT. NOT EXECUTED. NOT MIGRATED.
--   Do NOT run until the owner explicitly authorizes the Schema Apply phase.
--   Migration copy (kept in sync): supabase/migrations/00019_inventory_central.sql
--
-- PURPOSE
