-- ============================================================================
-- FOCUS — ADS · PER-SLIDE DEVICE (MIGRATION 00021 — FILE ONLY, NOT EXECUTED)
--
...
--   Same convention as 00019/00020 (FILE ONLY, NOT EXECUTED — applied via the
--   SQL Editor as postgres).
--
-- PURPOSE
--   Associate EACH ad_images row with its OWN inventory device so every
--   carousel slide can drive its own phone-details/WhatsApp handoff. The new
--   RPCs (ad_replace_images_devices / ad_add_image_devices) mirror the 00020
--   RPCs exactly (admin gate, path-prefix rule, storage-object existence
--   check, at-most-one-cover, all-or-nothing) plus device_id / p_device_ids[].
--   The DB enforces FORMAT ONLY; inventory existence lives in the Ads Manager.
-- ============================================================================
